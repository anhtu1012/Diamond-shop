...
function LacVongTayKimCuong() {
  const { allProduct } = useOutletContext();
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  const [currentPage, setCurrentPage] = useState(1);
  const [currentCategory] = useState("Lắc/ Vòng Tay Kim Cương");
        ...
        <div className="category-product">
          <Content style={{ padding: "0 0px" }}>
            <Breadcrumb style={{ margin: "16px 0" }}>
              ...
              <Breadcrumb.Item>Lắc vòng tay kim cương</Breadcrumb.Item>
            </Breadcrumb>
            <div
              style={{
...
export default LacVongTayKimCuong;
